"servers/InternetGamesPage.res"
{
	...
	layout
	{
		...
		place { control="AddServerButton,RefreshQuickButton,RefreshButton,ConnectButton" region="bottom" margin-right=8 spacing=8 height=24 align=right margin-bottom=8 }
