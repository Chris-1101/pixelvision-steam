"friends/ClanEventNotification.res"
{
	...
	styles
	{
		Notification
		{
			render_bg
			{
				...
				1="image( x1 - 239, y0 + 1, x1 - 1, y0 + 73, graphics/not_community_event )"
	...
	layout
	{
		...
		place { control=LabelGroup		x=64 y=15 width=176 height=30 }
		place { control=LabelInfo		x=64 y=29 width=176 height=30 }
		place { control=LabelEventTitle	x=64 y=43 width=176 height=30 }
	}
}