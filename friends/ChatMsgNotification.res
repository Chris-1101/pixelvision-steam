"friends/ChatMsgNotification.res"
{
	...
	styles
	{
		Notification
		{
			render_bg
			{
				...
				1="image( x1 - 239, y0 + 1, x1 - 1, y0 + 73, graphics/not_chat )"
	...
	layout
	{
		...
		place { control=LabelInfo y=15 width=176 height=30 end-left=LabelSender }
		place { control=LabelSender,LabelInfo x=64 y=15 width=max height=30 spacing=5 }
		place { control=LabelMessage x=64 y=29 width=176 height=30 }
	}
}